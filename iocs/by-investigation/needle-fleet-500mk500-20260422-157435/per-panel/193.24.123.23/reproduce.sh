#!/bin/bash
# Reproduce Needle panel fingerprint for 193.24.123.23 (verified 2026-04-22 02:53 UTC)
set -e
HOST="193.24.123.23"
...
sha256sum bundle.js
echo "Expected: fd7a5672830559be13c2478c948f952da61b7e3e4aa4e772e46d808be0fcc2d0  (size 964486)"
