#!/bin/bash
# Reproduce Needle panel fingerprint for 144.31.151.223 (verified 2026-04-22 02:53 UTC)
set -e
HOST="144.31.151.223"
...
sha256sum bundle.js
echo "Expected: 0439a5cf6512034af3f7fe7ab0d3a8edf4dc8fa3731c4e38189d2c4fd81a695b  (size 1220525)"
